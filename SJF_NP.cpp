...
struct cmp_readyQ
{
    ...
    {
        long long int remTime1 = (p1.no_CPU_execs == 0) ? p1.Burst_time_1 : p1.Burst_time_2;
        long long int remTime2 = (p2.no_CPU_execs == 0) ? p2.Burst_time_1 : p2.Burst_time_2;
...
int main(){
    //freopen("output_sjf_np.txt", "w", stdout);
    ...
    //create sjf non-preemptive scheduler object and pass list of all processes to it for constructor 
    CPUScheduler sjf_np_scheduler(processes);
    
    //invoke sjf non-preemptive scheduler
    sjf_np_scheduler.schedule();

    //print gant chart
    // for(auto s : sjf_np_scheduler.gant_chart){
    //     cout << s << "\n";
    // }
    // cout << "\n";
    ...
    // for(auto p : sjf_np_scheduler.terminated_q){
    ...
    vector<Process> completedProcessesVector = sjf_np_scheduler.terminated_q;
    ...
    system("python3 graph.py SJFNP.jpeg SJFNP");
	system("python3 graph1.py SJFNPPie.jpeg SJFNP");
    system("python3 stack.py SJFNPstack.jpeg SJFNP");
    remove("out.csv");
